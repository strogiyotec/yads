...
--awful.layout.set(lain.layout.termfair.center,screen.tags["browser"])
...
--Screen
        awful.key({ }, "Print", function()
            awful.util.spawn("flameshot gui -d 1000", false)
        end),
...
awful.spawn.with_shell("~/.config/awesome/autorun.sh") -- transparency
